...
final class ReplaceListenerImpl implements ReplaceListener {
    ...
    private static final Logger LOGGER = Logger
            .getLogger(ReplaceListenerImpl.class.getName());
    ...
    ReplaceListenerImpl(final BrowserPage browserPage,
    ...
    public void replacedWith(final AbstractHtml parentTag,
        ...
        // { "name": task_byte, "values" : [REPLACED_WITH_TAGS_byte_from_Task_enum]}, { "name": parent_data-wff-id, "values" : [ parent_tag_name, inserted_tag_html, before_tag_name, before_tag_data-wff-id, 1_if_there_was_a_previous_parent ]}
        // { "name": 2, "values" : [[3]]}, { "name":"C55", "values" : ["div", "<span></span>", 1]}
        //@formatter:on

        final NameValue task = Task.REPLACED_WITH_TAGS.getTaskNameValue();
        ...
        if (parentTag.getDataWffId() != null) {
            ...
            // end beforeTag/replacingTag data
