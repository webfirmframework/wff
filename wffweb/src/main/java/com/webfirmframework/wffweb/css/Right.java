...
public class Right extends AbstractCssProperty<Right> {
    ...
    /**
     * @param right the {@code Right} object from which the cssValue to set.And,
     ...
     * @author WFF
     */
    public Right setValue(final float value, final CssLengthUnit cssLengthUnit) {
        this.value = value;
        this.cssLengthUnit = cssLengthUnit;
        cssValue = String.valueOf(value) + cssLengthUnit;
    ...
    /**
     * gets the width in float value. {@code Right#getUnit()} should be used to get
