 ...
 * @since 1.0.0
 */
public class BorderTopColor extends AbstractCssProperty<BorderTopColor> implements StateChangeInformer<Bean> {

    private static final long serialVersionUID = 1_0_0L;

    private static final Logger LOGGER = Logger.getLogger(BorderTopColor.class.getName());
    ...
    /**
     * @param borderTopColor the {@code BorderTopColor} object from which the
