...
public class OutlineOffset extends AbstractCssProperty<OutlineOffset> {
    ...
    /**
     * @param outlineOffset the {@code OutlineOffset} object from which the cssValue
     ...
     * @author WFF
     */
    public OutlineOffset setValue(final float value, final CssLengthUnit cssLengthUnit) {
        this.value = value;
        this.cssLengthUnit = cssLengthUnit;
        cssValue = String.valueOf(value) + cssLengthUnit;
