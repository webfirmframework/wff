...
public class MozFlexBasis extends AbstractCssProperty<MozFlexBasis> {
    ...
    /**
     * @param mozFlexBasis the {@code MozFlexBasis} object from which the cssValue
     ...
     * @author WFF
     */
    public MozFlexBasis setValue(final float value, final CssLengthUnit cssLengthUnit) {
        this.value = value;
        this.cssLengthUnit = cssLengthUnit;
        cssValue = String.valueOf(value) + cssLengthUnit;
    ...
    /**
     * gets the width in float value. {@code MozFlexBasis#getUnit()} should be used
