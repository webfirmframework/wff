...
public class BorderBottomWidth extends AbstractCssProperty<BorderBottomWidth> {
     ...
     * @param cssLengthUnit
     */
    public BorderBottomWidth(final float value, final CssLengthUnit cssLengthUnit) {
     ...
     * @author WFF
     */
    public BorderBottomWidth setValue(final float value, final CssLengthUnit cssLengthUnit) {
        this.value = Float.valueOf(value);
        this.cssLengthUnit = cssLengthUnit;
        cssValue = String.valueOf(value).concat(cssLengthUnit.toString());
     ...
     * {@code BorderBottomWidth#getUnit()} should be used to get the cssLengthUnit
     * for this value.
     *
     * @return the value in <code>Float</code> or null if the border-bottom-width is
     *         set as <code>initial</code> or <code>inherit</code>.
     * @since 1.0.0
     * @author WFF
     */
