...
public class WebkitColumnCount extends AbstractCssProperty<WebkitColumnCount> {
    ...
    /**
     * @param webkitColumnCount the {@code webkitColumnCount} object from which the
    ...
    public static boolean isValid(final String cssValue) {
        ...
        try {
            ...
            return (parsedValue == 0
                    && (StringUtil.containsMinus(trimmedCssValue) || StringUtil.containsPlus(trimmedCssValue))) ? false
                            : true;
        } catch (final NumberFormatException e) {
        }
