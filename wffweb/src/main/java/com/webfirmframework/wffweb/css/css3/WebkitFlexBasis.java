...
public class WebkitFlexBasis extends AbstractCssProperty<WebkitFlexBasis> {
    ...
    /**
     * @param webkitFlexBasis the {@code WebkitFlexBasis} object from which the
     ...
     * @param cssLengthUnit
     */
    public WebkitFlexBasis(final float value, final CssLengthUnit cssLengthUnit) {
        this.value = value;
     ...
     * @author WFF
     */
    public WebkitFlexBasis setValue(final float value, final CssLengthUnit cssLengthUnit) {
        this.value = value;
        this.cssLengthUnit = cssLengthUnit;
        cssValue = String.valueOf(value) + cssLengthUnit;
    ...
    /**
     * gets the width in float value. {@code WebkitFlexBasis#getUnit()} should be
