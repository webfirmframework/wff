...
public class BorderRightColor extends AbstractCssProperty<BorderRightColor> implements StateChangeInformer<Bean> {
    ...
    private static final Logger LOGGER = Logger.getLogger(BorderRightColor.class.getName());
    ...
    /**
     * @param borderRightColor the {@code BorderRightColor} object from which the
    ...
    public void setRgbCssValue(final RgbCssValue rgbCssValue) {
        ...
        if (this.rgbCssValue != null) {
            if (rgbCssValue.isAlreadyInUse() && !Objects.equals(this.rgbCssValue.getStateChangeInformer(),
