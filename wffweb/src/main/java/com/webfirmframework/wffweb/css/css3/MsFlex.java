 ...
 * @since 1.0.0
 */
public class MsFlex extends AbstractCssProperty<MsFlex> implements StateChangeInformer<CssProperty> {

    private static final long serialVersionUID = 1_0_0L;

    private static final Logger LOGGER = Logger.getLogger(MsFlex.class.getName());
    ...
    /**
     * @param msFlex the {@code Flex} object from which the cssValue to set.And,
