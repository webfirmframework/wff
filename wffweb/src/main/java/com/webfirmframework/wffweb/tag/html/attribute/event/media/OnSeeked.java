...
public class OnSeeked extends AbstractEventAttribute {
    ...
    public OnSeeked(final String jsPreFunctionBody, final ServerAsyncMethod serverAsyncMethod,
     ...
     * @since 3.0.2
     */
    public OnSeeked(final ServerAsyncMethod serverAsyncMethod, final Object serverSideData) {
