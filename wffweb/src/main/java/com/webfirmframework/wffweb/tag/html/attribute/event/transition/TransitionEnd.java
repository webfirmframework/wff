...
public class TransitionEnd extends AbstractEventAttribute {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.TRANSITIONEND;
    ...
    public TransitionEnd(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public TransitionEnd(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public TransitionEnd(final ServerMethod serverMethod, final Object serverSideData) {
