...
public class OnWaiting extends AbstractEventAttribute {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONWAITING;
    ...
    public OnWaiting(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnWaiting(final String jsPreFunctionBody, final ServerMethod serverMethod, final String jsFilterFunctionBody,
     ...
     * @since 3.0.2
     */
    public OnWaiting(final ServerMethod serverMethod, final Object serverSideData) {
