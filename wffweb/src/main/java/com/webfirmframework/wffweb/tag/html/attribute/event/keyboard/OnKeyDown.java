...
public class OnKeyDown extends AbstractEventAttribute implements InputAttributable, TextAreaAttributable {
    ...
    static {
        PRE_INDEXED_ATTR_NAME = (PreIndexedAttributeName.ONKEYDOWN);
    ...
    public OnKeyDown(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnKeyDown(final String jsPreFunctionBody, final ServerMethod serverMethod, final String jsFilterFunctionBody,
     ...
     * @since 3.0.2
     */
    public OnKeyDown(final ServerMethod serverMethod, final Object serverSideData) {
