...
public class OnBlur extends AbstractEventAttribute implements AAttributable {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONBLUR;
    ...
    public OnBlur(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnBlur(final String jsPreFunctionBody, final ServerMethod serverMethod, final String jsFilterFunctionBody,
     ...
     * @since 3.0.2
     */
    public OnBlur(final ServerMethod serverMethod, final Object serverSideData) {
