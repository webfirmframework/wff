 ...
 *
 */
public class CrossOrigin extends AbstractAttribute implements ImgAttributable, AudioAttributable, VideoAttributable, ScriptAttributable, LinkAttributable {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.CROSSORIGIN;
    ...
    public CrossOrigin() {
        //attribute name only (without value part) is valid
        super.setAttributeValue(null);
    }

    /**
     * @param value eg: anonymous
     */
    public CrossOrigin(final String value) {
