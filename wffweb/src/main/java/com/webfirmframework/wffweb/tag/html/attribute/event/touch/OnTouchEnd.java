...
public class OnTouchEnd extends AbstractEventAttribute {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONTOUCHEND;
    ...
    public OnTouchEnd(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnTouchEnd(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnTouchEnd(final ServerMethod serverMethod, final Object serverSideData) {
