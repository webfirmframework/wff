 ...
 *
 */
public class OnAbort extends AbstractEventAttribute implements InputAttributable, TextAreaAttributable {
    ...
    static {
        PRE_INDEXED_ATTR_NAME = (PreIndexedAttributeName.ONABORT);
    ...
    public OnAbort(final String jsPreFunctionBody, final ServerAsyncMethod serverAsyncMethod,
     ...
     * @since 3.0.2
     */
    public OnAbort(final ServerAsyncMethod serverAsyncMethod, final Object serverSideData) {
