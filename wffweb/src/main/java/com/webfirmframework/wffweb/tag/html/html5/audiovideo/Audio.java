...
public class Audio extends AbstractHtml {
    ...
    private static final long serialVersionUID = 6830709952220094224L;
    ...
    public Audio(final AbstractHtml base, final AbstractAttribute... attributes) {
        ...
        if (WffConfiguration.isDirectionWarningOn()) {
            for (final AbstractAttribute abstractAttribute : attributes) {
                if (!(abstractAttribute != null && (abstractAttribute instanceof AudioAttribute || abstractAttribute instanceof GlobalAttribute))) {
