...
public class OnScroll extends AbstractEventAttribute implements InputAttributable, TextAreaAttributable {
    ...
    static {
        PRE_INDEXED_ATTR_NAME = (PreIndexedAttributeName.ONSCROLL);
    ...
    public OnScroll(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnScroll(final String jsPreFunctionBody, final ServerMethod serverMethod, final String jsFilterFunctionBody,
     ...
     * @since 3.0.2
     */
    public OnScroll(final ServerMethod serverMethod, final Object serverSideData) {
