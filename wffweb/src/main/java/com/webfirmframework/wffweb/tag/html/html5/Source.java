...
public class Source extends AbstractHtml {
    ...
    private static final long serialVersionUID = 6038452579312514397L;
    ...
    public Source(final AbstractHtml base,
        ...
        if (WffConfiguration.isDirectionWarningOn()) {
            for (final AbstractAttribute abstractAttribute : attributes) {
                if (!(abstractAttribute != null && (abstractAttribute instanceof SourceAttribute || abstractAttribute instanceof GlobalAttribute))) {
