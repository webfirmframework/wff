...
public class OnTimeUpdate extends AbstractEventAttribute {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONTIMEUPDATE;
    ...
    public OnTimeUpdate(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnTimeUpdate(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnTimeUpdate(final ServerMethod serverMethod, final Object serverSideData) {
