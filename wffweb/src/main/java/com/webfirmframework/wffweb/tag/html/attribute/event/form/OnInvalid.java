...
public class OnInvalid extends AbstractEventAttribute implements AAttributable {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONINVALID;
    ...
    public OnInvalid(final ServerMethod serverMethod) {
     ...
     * @since 3.0.2
     */
    public OnInvalid(final ServerMethod serverMethod, final Object serverSideData) {
