...
public class DataList extends AbstractHtml {
    ...
    private static final PreIndexedTagName PRE_INDEXED_TAG_NAME = PreIndexedTagName.DATALIST;
     ...
     * @since 1.0.0
     */
    public DataList(final AbstractHtml base, final AbstractAttribute... attributes) {
    ...
    private static void warnForUnsupportedAttributes(final AbstractAttribute... attributes) {
        for (final AbstractAttribute abstractAttribute : attributes) {
            if (!(abstractAttribute != null && (abstractAttribute instanceof DataListAttributable
                    || abstractAttribute instanceof GlobalAttributable))) {
                LOGGER.warning(abstractAttribute + " is not an instance of DataListAttribute");
            }
        }
    }
