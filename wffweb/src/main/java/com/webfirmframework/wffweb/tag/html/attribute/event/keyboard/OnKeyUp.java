...
public class OnKeyUp extends AbstractEventAttribute implements InputAttributable, TextAreaAttributable {
    ...
    public OnKeyUp(final String jsPreFunctionBody, final ServerAsyncMethod serverAsyncMethod,
     ...
     * @since 3.0.2
     */
    public OnKeyUp(final ServerAsyncMethod serverAsyncMethod, final Object serverSideData) {
