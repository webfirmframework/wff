 ...
 *
 */
public class OnDblClick extends AbstractEventAttribute implements AAttributable {
    ...
    static {
        PRE_INDEXED_ATTR_NAME = (PreIndexedAttributeName.ONDBLCLICK);
    ...
    public OnDblClick(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnDblClick(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnDblClick(final ServerMethod serverMethod, final Object serverSideData) {
