...
public class OnKeyPress extends AbstractEventAttribute implements InputAttributable, TextAreaAttributable {
    ...
    public OnKeyPress(final String jsPreFunctionBody, final ServerAsyncMethod serverAsyncMethod,
     ...
     * @since 3.0.2
     */
    public OnKeyPress(final ServerAsyncMethod serverAsyncMethod, final Object serverSideData) {
