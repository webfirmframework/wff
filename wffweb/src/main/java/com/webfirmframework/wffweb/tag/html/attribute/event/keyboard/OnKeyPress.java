 ...
 *
 */
public class OnKeyPress extends AbstractEventAttribute implements InputAttributable, TextAreaAttributable {
    ...
    static {
        PRE_INDEXED_ATTR_NAME = (PreIndexedAttributeName.ONKEYPRESS);
    ...
    public OnKeyPress(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnKeyPress(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnKeyPress(final ServerMethod serverMethod, final Object serverSideData) {
