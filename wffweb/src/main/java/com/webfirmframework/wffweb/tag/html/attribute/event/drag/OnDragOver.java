...
public class OnDragOver extends AbstractEventAttribute {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONDRAGOVER;
    ...
    public OnDragOver(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnDragOver(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnDragOver(final ServerMethod serverMethod, final Object serverSideData) {
