...
import com.webfirmframework.wffweb.tag.html.html5.identifier.KeyGenAttribute;
...
public class KeyGen extends AbstractHtml {
    ...
    private static final long serialVersionUID = -3817523956305350498L;
    ...
    public KeyGen(final AbstractHtml base,
        ...
        if (WffConfiguration.isDirectionWarningOn()) {
            for (final AbstractAttribute abstractAttribute : attributes) {
                if (!(abstractAttribute != null && (abstractAttribute instanceof KeyGenAttribute || abstractAttribute instanceof GlobalAttribute))) {
