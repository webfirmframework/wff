...
public class OnDrag extends AbstractEventAttribute {
    ...
    public OnDrag(final String jsPreFunctionBody, final ServerAsyncMethod serverAsyncMethod,
     ...
     * @since 3.0.2
     */
    public OnDrag(final ServerAsyncMethod serverAsyncMethod, final Object serverSideData) {
