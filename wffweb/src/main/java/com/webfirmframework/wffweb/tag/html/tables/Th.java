...
import com.webfirmframework.wffweb.tag.html.identifier.ThAttribute;
...
public class Th extends AbstractHtml {
    ...
    private static final long serialVersionUID = -4610317184265653565L;
    ...
    public Th(final AbstractHtml base, final AbstractAttribute... attributes) {
        ...
        if (WffConfiguration.isDirectionWarningOn()) {
            for (final AbstractAttribute abstractAttribute : attributes) {
                if (!(abstractAttribute != null && (abstractAttribute instanceof ThAttribute || abstractAttribute instanceof GlobalAttribute))) {
