...
public class OnPlaying extends AbstractEventAttribute {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONPLAYING;
    ...
    public OnPlaying(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnPlaying(final String jsPreFunctionBody, final ServerMethod serverMethod, final String jsFilterFunctionBody,
     ...
     * @since 3.0.2
     */
    public OnPlaying(final ServerMethod serverMethod, final Object serverSideData) {
