...
import com.webfirmframework.wffweb.tag.html.identifier.LiAttribute;
...
public class Li extends AbstractHtml {
    ...
    public Li(final AbstractHtml base, final AbstractAttribute... attributes) {
        super(Li.class.getSimpleName().toLowerCase(), base, attributes);
        if (WffConfiguration.isDirectionWarningOn()) {
            for (final AbstractAttribute abstractAttribute : attributes) {
                if (!(abstractAttribute != null && (abstractAttribute instanceof LiAttribute || abstractAttribute instanceof GlobalAttribute))) {
