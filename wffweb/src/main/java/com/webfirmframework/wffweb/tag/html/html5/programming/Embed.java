...
import com.webfirmframework.wffweb.tag.html.html5.identifier.EmbedAttribute;
    ...
    public Embed(final AbstractHtml base, final AbstractAttribute... attributes) {
        ...
        if (WffConfiguration.isDirectionWarningOn()) {
            for (final AbstractAttribute abstractAttribute : attributes) {
                if (!(abstractAttribute != null && (abstractAttribute instanceof EmbedAttribute || abstractAttribute instanceof GlobalAttribute))) {
