...
import com.webfirmframework.wffweb.tag.html.identifier.StrongAttribute;
    ...
    public Strong(final AbstractHtml base,
        ...
        if (WffConfiguration.isDirectionWarningOn()) {
            for (final AbstractAttribute abstractAttribute : attributes) {
                if (!(abstractAttribute != null && (abstractAttribute instanceof StrongAttribute || abstractAttribute instanceof GlobalAttribute))) {
