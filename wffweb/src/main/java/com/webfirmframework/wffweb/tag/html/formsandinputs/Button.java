...
public class Button extends AbstractHtml {
    ...
    private static final PreIndexedTagName PRE_INDEXED_TAG_NAME = PreIndexedTagName.BUTTON;
     ...
     * @since 1.0.0
     */
    public Button(final AbstractHtml base, final AbstractAttribute... attributes) {
    ...
    private static void warnForUnsupportedAttributes(final AbstractAttribute... attributes) {
        for (final AbstractAttribute abstractAttribute : attributes) {
            if (!(abstractAttribute != null && (abstractAttribute instanceof ButtonAttributable
                    || abstractAttribute instanceof GlobalAttributable))) {
                LOGGER.warning(abstractAttribute + " is not an instance of ButtonAttribute");
            }
        }
    }
