...
public class OnReset extends AbstractEventAttribute implements AAttributable {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONRESET;
    ...
    public OnReset(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnReset(final String jsPreFunctionBody, final ServerMethod serverMethod, final String jsFilterFunctionBody,
     ...
     * @since 3.0.2
     */
    public OnReset(final ServerMethod serverMethod, final Object serverSideData) {
