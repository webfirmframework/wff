...
public class OnStorage extends AbstractEventAttribute {
    ...
    public OnStorage(final String jsPreFunctionBody, final ServerAsyncMethod serverAsyncMethod,
     ...
     * @since 3.0.2
     */
    public OnStorage(final ServerAsyncMethod serverAsyncMethod, final Object serverSideData) {
