...
public class OnLoadedData extends AbstractEventAttribute {
    ...
    static {
        PRE_INDEXED_ATTR_NAME = (PreIndexedAttributeName.ONLOADEDDATA);
    ...
    public OnLoadedData(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnLoadedData(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnLoadedData(final ServerMethod serverMethod, final Object serverSideData) {
