...
public class OnResize extends AbstractEventAttribute implements InputAttributable, TextAreaAttributable {
    ...
    public OnResize(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnResize(final String jsPreFunctionBody, final ServerMethod serverMethod, final String jsFilterFunctionBody,
     ...
     * @since 3.0.2
     */
    public OnResize(final ServerMethod serverMethod, final Object serverSideData) {
