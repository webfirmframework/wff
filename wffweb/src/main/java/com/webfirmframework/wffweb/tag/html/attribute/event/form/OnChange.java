...
public class OnChange extends AbstractEventAttribute implements AAttributable {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONCHANGE;
    ...
    public OnChange(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnChange(final String jsPreFunctionBody, final ServerMethod serverMethod, final String jsFilterFunctionBody,
     ...
     * @since 3.0.2
     */
    public OnChange(final ServerMethod serverMethod, final Object serverSideData) {
