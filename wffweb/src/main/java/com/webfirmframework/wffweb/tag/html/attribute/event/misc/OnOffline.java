...
public class OnOffline extends AbstractEventAttribute {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONOFFLINE;
    ...
    public OnOffline(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnOffline(final String jsPreFunctionBody, final ServerMethod serverMethod, final String jsFilterFunctionBody,
     ...
     * @since 3.0.2
     */
    public OnOffline(final ServerMethod serverMethod, final Object serverSideData) {
