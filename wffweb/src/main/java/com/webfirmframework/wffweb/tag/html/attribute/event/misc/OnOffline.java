...
public class OnOffline extends AbstractEventAttribute {
    ...
    public OnOffline(final String jsPreFunctionBody, final ServerAsyncMethod serverAsyncMethod,
     ...
     * @since 3.0.2
     */
    public OnOffline(final ServerAsyncMethod serverAsyncMethod, final Object serverSideData) {
