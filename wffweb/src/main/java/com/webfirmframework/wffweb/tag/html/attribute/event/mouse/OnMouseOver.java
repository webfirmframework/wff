...
public class OnMouseOver extends AbstractEventAttribute implements AAttributable {
    ...
    static {
        PRE_INDEXED_ATTR_NAME = (PreIndexedAttributeName.ONMOUSEOVER);
    ...
    public OnMouseOver(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnMouseOver(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnMouseOver(final ServerMethod serverMethod, final Object serverSideData) {
