...
public class Template extends AbstractHtml {
    ...
    static {
        ...
        PRE_INDEXED_TAG_NAME = (PreIndexedTagName.TEMPLATE);
     ...
     *
     */
    public Template(final AbstractHtml base, final AbstractAttribute... attributes) {
    ...
    private static void warnForUnsupportedAttributes(final AbstractAttribute... attributes) {
        for (final AbstractAttribute abstractAttribute : attributes) {
            if (!(abstractAttribute != null && (abstractAttribute instanceof TemplateAttributable
                    || abstractAttribute instanceof GlobalAttributable))) {
                LOGGER.warning(abstractAttribute + " is not an instance of TemplateAttribute");
            }
        }
    }
