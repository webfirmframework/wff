...
public class OnLoadedMetaData extends AbstractEventAttribute {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONLOADEDMETADATA;
    ...
    public OnLoadedMetaData(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnLoadedMetaData(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnLoadedMetaData(final ServerMethod serverMethod, final Object serverSideData) {
