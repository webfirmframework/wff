...
public class OnLoadedMetaData extends AbstractEventAttribute {
    ...
    public OnLoadedMetaData(final String jsPreFunctionBody, final ServerAsyncMethod serverAsyncMethod,
     ...
     * @since 3.0.2
     */
    public OnLoadedMetaData(final ServerAsyncMethod serverAsyncMethod, final Object serverSideData) {
