...
public class OnContextMenu extends AbstractEventAttribute implements AAttributable {
    ...
    public OnContextMenu(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnContextMenu(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnContextMenu(final ServerMethod serverMethod, final Object serverSideData) {
