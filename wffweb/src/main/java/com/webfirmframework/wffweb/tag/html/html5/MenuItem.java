...
import com.webfirmframework.wffweb.tag.html.html5.identifier.MenuItemAttribute;
...
public class MenuItem extends AbstractHtml {
    ...
    private static final long serialVersionUID = -4330473368076590704L;
    ...
    public MenuItem(final AbstractHtml base,
        ...
        if (WffConfiguration.isDirectionWarningOn()) {
            for (final AbstractAttribute abstractAttribute : attributes) {
                if (!(abstractAttribute != null && (abstractAttribute instanceof MenuItemAttribute || abstractAttribute instanceof GlobalAttribute))) {
