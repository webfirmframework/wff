...
public class OnAfterPrint extends AbstractEventAttribute {
    ...
    public OnAfterPrint(final String jsPreFunctionBody, final ServerAsyncMethod serverAsyncMethod,
     ...
     * @since 3.0.2
     */
    public OnAfterPrint(final ServerAsyncMethod serverAsyncMethod, final Object serverSideData) {
