...
public class OnAfterPrint extends AbstractEventAttribute {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONAFTERPRINT;
    ...
    public OnAfterPrint(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnAfterPrint(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnAfterPrint(final ServerMethod serverMethod, final Object serverSideData) {
