...
public class OnRateChange extends AbstractEventAttribute {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONRATECHANGE;
    ...
    public OnRateChange(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnRateChange(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnRateChange(final ServerMethod serverMethod, final Object serverSideData) {
