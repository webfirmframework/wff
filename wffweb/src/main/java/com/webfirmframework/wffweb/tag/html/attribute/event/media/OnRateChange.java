...
public class OnRateChange extends AbstractEventAttribute {
    ...
    public OnRateChange(final String jsPreFunctionBody, final ServerAsyncMethod serverAsyncMethod,
     ...
     * @since 3.0.2
     */
    public OnRateChange(final ServerAsyncMethod serverAsyncMethod, final Object serverSideData) {
