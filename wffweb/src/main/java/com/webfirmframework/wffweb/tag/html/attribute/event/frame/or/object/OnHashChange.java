 ...
 *
 */
public class OnHashChange extends AbstractEventAttribute implements InputAttributable, TextAreaAttributable {
    ...
    static {
        PRE_INDEXED_ATTR_NAME = (PreIndexedAttributeName.ONHASHCHANGE);
    ...
    public OnHashChange(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnHashChange(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnHashChange(final ServerMethod serverMethod, final Object serverSideData) {
