...
import com.webfirmframework.wffweb.tag.html.identifier.HrAttribute;
...
public class Hr extends AbstractHtml {
    ...
    private static final long serialVersionUID = 8856268407997670853L;
    ...
    public Hr(final AbstractHtml base, final AbstractAttribute... attributes) {
        ...
        if (WffConfiguration.isDirectionWarningOn()) {
            for (final AbstractAttribute abstractAttribute : attributes) {
                if (!(abstractAttribute != null && (abstractAttribute instanceof HrAttribute || abstractAttribute instanceof GlobalAttribute))) {
