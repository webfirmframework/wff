...
public class OnDragLeave extends AbstractEventAttribute {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONDRAGLEAVE;
    ...
    public OnDragLeave(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnDragLeave(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnDragLeave(final ServerMethod serverMethod, final Object serverSideData) {
