...
public class OnSuspend extends AbstractEventAttribute {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONSUSPEND;
    ...
    public OnSuspend(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnSuspend(final String jsPreFunctionBody, final ServerMethod serverMethod, final String jsFilterFunctionBody,
     ...
     * @since 3.0.2
     */
    public OnSuspend(final ServerMethod serverMethod, final Object serverSideData) {
