...
public class OnSuspend extends AbstractEventAttribute {
    ...
    public OnSuspend(final String jsPreFunctionBody, final ServerAsyncMethod serverAsyncMethod,
     ...
     * @since 3.0.2
     */
    public OnSuspend(final ServerAsyncMethod serverAsyncMethod, final Object serverSideData) {
