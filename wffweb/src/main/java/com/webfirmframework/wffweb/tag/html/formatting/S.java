...
import com.webfirmframework.wffweb.tag.html.identifier.SAttribute;
...
public class S extends AbstractHtml {
    ...
    private static final long serialVersionUID = -2256552139100098370L;
    ...
    public S(final AbstractHtml base, final AbstractAttribute... attributes) {
        ...
        if (WffConfiguration.isDirectionWarningOn()) {
            for (final AbstractAttribute abstractAttribute : attributes) {
                if (!(abstractAttribute != null && (abstractAttribute instanceof SAttribute || abstractAttribute instanceof GlobalAttribute))) {
