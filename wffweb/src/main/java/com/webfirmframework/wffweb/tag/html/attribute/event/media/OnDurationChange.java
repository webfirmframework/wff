...
public class OnDurationChange extends AbstractEventAttribute {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONDURATIONCHANGE;
    ...
    public OnDurationChange(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnDurationChange(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnDurationChange(final ServerMethod serverMethod, final Object serverSideData) {
