...
public class OnDurationChange extends AbstractEventAttribute {
    ...
    public OnDurationChange(final String jsPreFunctionBody, final ServerAsyncMethod serverAsyncMethod,
     ...
     * @since 3.0.2
     */
    public OnDurationChange(final ServerAsyncMethod serverAsyncMethod, final Object serverSideData) {
