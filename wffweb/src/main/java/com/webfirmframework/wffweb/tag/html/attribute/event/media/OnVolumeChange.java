...
public class OnVolumeChange extends AbstractEventAttribute {
    ...
    public OnVolumeChange(final String jsPreFunctionBody, final ServerAsyncMethod serverAsyncMethod,
     ...
     * @since 3.0.2
     */
    public OnVolumeChange(final ServerAsyncMethod serverAsyncMethod, final Object serverSideData) {
