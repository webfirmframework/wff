...
public class OnVolumeChange extends AbstractEventAttribute {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONVOLUMECHANGE;
    ...
    public OnVolumeChange(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnVolumeChange(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnVolumeChange(final ServerMethod serverMethod, final Object serverSideData) {
