...
public class OnCanPlay extends AbstractEventAttribute {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONCANPLAY;
    ...
    public OnCanPlay(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnCanPlay(final String jsPreFunctionBody, final ServerMethod serverMethod, final String jsFilterFunctionBody,
     ...
     * @since 3.0.2
     */
    public OnCanPlay(final ServerMethod serverMethod, final Object serverSideData) {
