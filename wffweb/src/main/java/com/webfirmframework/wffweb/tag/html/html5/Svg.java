...
public class Svg extends AbstractHtml {
    ...
    private static final long serialVersionUID = -8701999727100702071L;
    ...
    public Svg(final AbstractHtml base, final AbstractAttribute... attributes) {
        ...
        if (WffConfiguration.isDirectionWarningOn()) {
            for (final AbstractAttribute abstractAttribute : attributes) {
                if (!(abstractAttribute != null && (abstractAttribute instanceof SvgAttribute || abstractAttribute instanceof GlobalAttribute))) {
