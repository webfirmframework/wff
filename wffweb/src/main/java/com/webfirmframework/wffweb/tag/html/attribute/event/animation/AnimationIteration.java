...
public class AnimationIteration extends AbstractEventAttribute {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ANIMATIONITERATION;
    ...
    public AnimationIteration(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public AnimationIteration(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public AnimationIteration(final ServerMethod serverMethod, final Object serverSideData) {
