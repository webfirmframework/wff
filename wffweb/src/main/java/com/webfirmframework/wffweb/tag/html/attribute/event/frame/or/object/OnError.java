...
public class OnError extends AbstractEventAttribute implements InputAttributable, TextAreaAttributable {
    ...
    public OnError(final String jsPreFunctionBody, final ServerAsyncMethod serverAsyncMethod,
     ...
     * @since 3.0.2
     */
    public OnError(final ServerAsyncMethod serverAsyncMethod, final Object serverSideData) {
