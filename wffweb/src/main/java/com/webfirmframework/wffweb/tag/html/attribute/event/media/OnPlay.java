...
public class OnPlay extends AbstractEventAttribute {
    ...
    public OnPlay(final String jsPreFunctionBody, final ServerAsyncMethod serverAsyncMethod,
     ...
     * @since 3.0.2
     */
    public OnPlay(final ServerAsyncMethod serverAsyncMethod, final Object serverSideData) {
