...
public class Ellipse extends AbstractHtml {
    ...
    private static final Logger LOGGER = Logger.getLogger(Ellipse.class.getName());

    private static final PreIndexedTagName PRE_INDEXED_TAG_NAME = PreIndexedTagName.ELLIPSE;
     ...
     *
     */
    public Ellipse(final AbstractHtml base, final AbstractAttribute... attributes) {
    ...
    private static void warnForUnsupportedAttributes(final AbstractAttribute... attributes) {
        for (final AbstractAttribute abstractAttribute : attributes) {
            if (!(abstractAttribute != null && (abstractAttribute instanceof EllipseAttributable
