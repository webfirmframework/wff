 ...
 *
 */
public class OnFocusOut extends AbstractEventAttribute implements AAttributable {

    private static final long serialVersionUID = 1_0_0L;

    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONFOCUSOUT;
    ...
    public OnFocusOut(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnFocusOut(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnFocusOut(final ServerMethod serverMethod, final Object serverSideData) {
