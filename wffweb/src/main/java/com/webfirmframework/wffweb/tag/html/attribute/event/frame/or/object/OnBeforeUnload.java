 ...
 *
 */
public class OnBeforeUnload extends AbstractEventAttribute implements InputAttributable, TextAreaAttributable {
    ...
    public OnBeforeUnload(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnBeforeUnload(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnBeforeUnload(final ServerMethod serverMethod, final Object serverSideData) {
