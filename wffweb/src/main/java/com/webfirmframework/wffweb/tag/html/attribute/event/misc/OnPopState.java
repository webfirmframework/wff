...
public class OnPopState extends AbstractEventAttribute {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONPOPSTATE;
    ...
    public OnPopState(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnPopState(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnPopState(final ServerMethod serverMethod, final Object serverSideData) {
