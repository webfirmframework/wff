...
public class OnPaste extends AbstractEventAttribute {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONPASTE;
    ...
    public OnPaste(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnPaste(final String jsPreFunctionBody, final ServerMethod serverMethod, final String jsFilterFunctionBody,
     ...
     * @since 3.0.2
     */
    public OnPaste(final ServerMethod serverMethod, final Object serverSideData) {
