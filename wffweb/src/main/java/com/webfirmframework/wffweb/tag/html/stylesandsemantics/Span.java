...
import com.webfirmframework.wffweb.tag.html.identifier.SpanAttribute;
    ...
    public Span(final AbstractHtml base, final AbstractAttribute... attributes) {
        ...
        if (WffConfiguration.isDirectionWarningOn()) {
            for (final AbstractAttribute abstractAttribute : attributes) {
                if (!(abstractAttribute != null && (abstractAttribute instanceof SpanAttribute || abstractAttribute instanceof GlobalAttribute))) {
