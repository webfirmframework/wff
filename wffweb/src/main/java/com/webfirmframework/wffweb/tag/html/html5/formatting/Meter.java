...
import com.webfirmframework.wffweb.tag.html.html5.identifier.MeterAttribute;
    ...
    public Meter(final AbstractHtml base, final AbstractAttribute... attributes) {
        ...
        if (WffConfiguration.isDirectionWarningOn()) {
            for (final AbstractAttribute abstractAttribute : attributes) {
                if (!(abstractAttribute != null && (abstractAttribute instanceof MeterAttribute || abstractAttribute instanceof GlobalAttribute))) {
