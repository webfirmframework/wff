...
public class OnFocus extends AbstractEventAttribute implements AAttributable {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONFOCUS;
    ...
    public OnFocus(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnFocus(final String jsPreFunctionBody, final ServerMethod serverMethod, final String jsFilterFunctionBody,
     ...
     * @since 3.0.2
     */
    public OnFocus(final ServerMethod serverMethod, final Object serverSideData) {
