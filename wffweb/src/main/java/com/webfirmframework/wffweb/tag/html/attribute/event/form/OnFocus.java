...
public class OnFocus extends AbstractEventAttribute implements AAttributable {
    ...
    public OnFocus(final String jsPreFunctionBody, final ServerAsyncMethod serverAsyncMethod,
     ...
     * @since 3.0.2
     */
    public OnFocus(final ServerAsyncMethod serverAsyncMethod, final Object serverSideData) {
