...
public class OnTouchMove extends AbstractEventAttribute {
    ...
    public OnTouchMove(final String jsPreFunctionBody, final ServerAsyncMethod serverAsyncMethod,
     ...
     * @since 3.0.2
     */
    public OnTouchMove(final ServerAsyncMethod serverAsyncMethod, final Object serverSideData) {
