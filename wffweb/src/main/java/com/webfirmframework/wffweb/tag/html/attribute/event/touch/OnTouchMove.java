...
public class OnTouchMove extends AbstractEventAttribute {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONTOUCHMOVE;
    ...
    public OnTouchMove(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnTouchMove(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnTouchMove(final ServerMethod serverMethod, final Object serverSideData) {
