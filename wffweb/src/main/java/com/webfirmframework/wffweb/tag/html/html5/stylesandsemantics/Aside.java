...
import com.webfirmframework.wffweb.tag.html.html5.identifier.AsideAttribute;
...
public class Aside extends AbstractHtml {
    ...
    private static final long serialVersionUID = 2413735448720308187L;
    ...
    public Aside(final AbstractHtml base, final AbstractAttribute... attributes) {
        ...
        if (WffConfiguration.isDirectionWarningOn()) {
            for (final AbstractAttribute abstractAttribute : attributes) {
                if (!(abstractAttribute != null && (abstractAttribute instanceof AsideAttribute || abstractAttribute instanceof GlobalAttribute))) {
