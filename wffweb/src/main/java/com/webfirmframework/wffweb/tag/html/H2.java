...
import com.webfirmframework.wffweb.tag.html.identifier.H2Attribute;
...
public class H2 extends AbstractHtml {
    ...
    private static final long serialVersionUID = -732892439902281164L;
    ...
    public H2(final AbstractHtml base, final AbstractAttribute... attributes) {
        ...
        if (WffConfiguration.isDirectionWarningOn()) {
            for (final AbstractAttribute abstractAttribute : attributes) {
                if (!(abstractAttribute != null && (abstractAttribute instanceof H2Attribute || abstractAttribute instanceof GlobalAttribute))) {
