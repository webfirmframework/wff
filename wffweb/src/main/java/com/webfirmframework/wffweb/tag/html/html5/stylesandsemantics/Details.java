...
public class Details extends AbstractHtml {
    ...
    static {
        ...
        PRE_INDEXED_TAG_NAME = (PreIndexedTagName.DETAILS);
     ...
     * @since 1.0.0
     */
    public Details(final AbstractHtml base, final AbstractAttribute... attributes) {
    ...
    private static void warnForUnsupportedAttributes(final AbstractAttribute... attributes) {
        for (final AbstractAttribute abstractAttribute : attributes) {
            if (!(abstractAttribute != null && (abstractAttribute instanceof DetailsAttributable
