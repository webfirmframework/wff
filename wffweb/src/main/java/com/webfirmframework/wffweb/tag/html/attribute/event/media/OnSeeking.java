...
public class OnSeeking extends AbstractEventAttribute {
    ...
    static {
        PRE_INDEXED_ATTR_NAME = (PreIndexedAttributeName.ONSEEKING);
    ...
    public OnSeeking(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnSeeking(final String jsPreFunctionBody, final ServerMethod serverMethod, final String jsFilterFunctionBody,
     ...
     * @since 3.0.2
     */
    public OnSeeking(final ServerMethod serverMethod, final Object serverSideData) {
