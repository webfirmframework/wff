...
public class OnSeeking extends AbstractEventAttribute {
    ...
    public OnSeeking(final String jsPreFunctionBody, final ServerAsyncMethod serverAsyncMethod,
     ...
     * @since 3.0.2
     */
    public OnSeeking(final ServerAsyncMethod serverAsyncMethod, final Object serverSideData) {
