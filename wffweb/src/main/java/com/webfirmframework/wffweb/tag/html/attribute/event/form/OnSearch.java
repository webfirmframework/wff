...
public class OnSearch extends AbstractEventAttribute implements AAttributable {
    ...
    static {
        PRE_INDEXED_ATTR_NAME = (PreIndexedAttributeName.ONSEARCH);
    ...
    public OnSearch(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnSearch(final String jsPreFunctionBody, final ServerMethod serverMethod, final String jsFilterFunctionBody,
     ...
     * @since 3.0.2
     */
    public OnSearch(final ServerMethod serverMethod, final Object serverSideData) {
