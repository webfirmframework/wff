...
public class OnCanPlayThrough extends AbstractEventAttribute {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONCANPLAYTHROUGH;
    ...
    public OnCanPlayThrough(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnCanPlayThrough(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnCanPlayThrough(final ServerMethod serverMethod, final Object serverSideData) {
