 ...
 *
 */
public class OnMouseMove extends AbstractEventAttribute implements AAttributable {
    ...
    static {
        PRE_INDEXED_ATTR_NAME = (PreIndexedAttributeName.ONMOUSEMOVE);
    ...
    public OnMouseMove(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnMouseMove(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnMouseMove(final ServerMethod serverMethod, final Object serverSideData) {
