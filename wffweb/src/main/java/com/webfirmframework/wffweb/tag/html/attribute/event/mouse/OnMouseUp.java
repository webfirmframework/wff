...
public class OnMouseUp extends AbstractEventAttribute implements AAttributable {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONMOUSEUP;
    ...
    public OnMouseUp(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnMouseUp(final String jsPreFunctionBody, final ServerMethod serverMethod, final String jsFilterFunctionBody,
     ...
     * @since 3.0.2
     */
    public OnMouseUp(final ServerMethod serverMethod, final Object serverSideData) {
