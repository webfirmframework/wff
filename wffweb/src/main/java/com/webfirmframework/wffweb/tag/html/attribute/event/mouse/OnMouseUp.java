...
public class OnMouseUp extends AbstractEventAttribute implements AAttributable {
    ...
    public OnMouseUp(final String jsPreFunctionBody, final ServerAsyncMethod serverAsyncMethod,
     ...
     * @since 3.0.2
     */
    public OnMouseUp(final ServerAsyncMethod serverAsyncMethod, final Object serverSideData) {
