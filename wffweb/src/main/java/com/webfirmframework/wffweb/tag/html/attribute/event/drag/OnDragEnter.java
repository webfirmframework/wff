...
public class OnDragEnter extends AbstractEventAttribute {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONDRAGENTER;
    ...
    public OnDragEnter(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnDragEnter(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnDragEnter(final ServerMethod serverMethod, final Object serverSideData) {
