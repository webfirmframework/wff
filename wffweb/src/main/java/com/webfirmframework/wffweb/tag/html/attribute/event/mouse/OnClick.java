...
public class OnClick extends AbstractEventAttribute implements AAttributable {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONCLICK;
    ...
    public OnClick(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnClick(final String jsPreFunctionBody, final ServerMethod serverMethod, final String jsFilterFunctionBody,
     ...
     * @since 3.0.2
     */
    public OnClick(final ServerMethod serverMethod, final Object serverSideData) {
     ...
     * @since 12.0.0-beta.2
     */
    public OnClick(final boolean preventDefault, final ServerMethod serverMethod) {
     ...
     * @since 12.0.0-beta.2
     */
    public OnClick(final boolean preventDefault, final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 12.0.0-beta.2
     */
    public OnClick(final boolean preventDefault, final ServerMethod serverMethod, final String jsFilterFunctionBody,
            final String jsPostFunctionBody) {
     ...
     * @since 12.0.0-beta.2
     */
    public OnClick(final boolean preventDefault, final ServerMethod serverMethod, final Object serverSideData) {
