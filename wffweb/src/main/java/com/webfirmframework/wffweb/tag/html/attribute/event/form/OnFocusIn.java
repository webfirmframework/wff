...
public class OnFocusIn extends AbstractEventAttribute implements AAttributable {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONFOCUSIN;
    ...
    public OnFocusIn(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnFocusIn(final String jsPreFunctionBody, final ServerMethod serverMethod, final String jsFilterFunctionBody,
     ...
     * @since 3.0.2
     */
    public OnFocusIn(final ServerMethod serverMethod, final Object serverSideData) {
