...
public class OnTouchStart extends AbstractEventAttribute {
    ...
    public OnTouchStart(final String jsPreFunctionBody, final ServerAsyncMethod serverAsyncMethod,
     ...
     * @since 3.0.2
     */
    public OnTouchStart(final ServerAsyncMethod serverAsyncMethod, final Object serverSideData) {
