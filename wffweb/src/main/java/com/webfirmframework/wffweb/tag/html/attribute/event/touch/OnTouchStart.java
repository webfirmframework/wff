...
public class OnTouchStart extends AbstractEventAttribute {
    ...
    private static final PreIndexedAttributeName PRE_INDEXED_ATTR_NAME = PreIndexedAttributeName.ONTOUCHSTART;
    ...
    public OnTouchStart(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnTouchStart(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnTouchStart(final ServerMethod serverMethod, final Object serverSideData) {
