...
import com.webfirmframework.wffweb.tag.html.identifier.TrAttribute;
...
public class Tr extends AbstractHtml {
    ...
    private static final long serialVersionUID = 6945505529360971875L;
    ...
    public Tr(final AbstractHtml base, final AbstractAttribute... attributes) {
        ...
        if (WffConfiguration.isDirectionWarningOn()) {
            for (final AbstractAttribute abstractAttribute : attributes) {
                if (!(abstractAttribute != null && (abstractAttribute instanceof TrAttribute || abstractAttribute instanceof GlobalAttribute))) {
