...
public class OnMouseLeave extends AbstractEventAttribute implements AAttributable {
    ...
    public OnMouseLeave(final ServerMethod serverMethod) {
        setServerMethod(null, serverMethod, null, null);
    }

    public OnMouseLeave(final String jsPreFunctionBody, final ServerMethod serverMethod,
     ...
     * @since 3.0.2
     */
    public OnMouseLeave(final ServerMethod serverMethod, final Object serverSideData) {
