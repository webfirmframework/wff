...
public class OnMouseLeave extends AbstractEventAttribute implements AAttributable {
    ...
    public OnMouseLeave(final String jsPreFunctionBody, final ServerAsyncMethod serverAsyncMethod,
     ...
     * @since 3.0.2
     */
    public OnMouseLeave(final ServerAsyncMethod serverAsyncMethod, final Object serverSideData) {
