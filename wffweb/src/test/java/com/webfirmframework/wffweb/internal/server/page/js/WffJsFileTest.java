...
public class WffJsFileTest {
    ...
    private static String expectedContent = """
            ...
            * v2;var v3 = v18
            ...
            itemObj.removed = true;itemObj.id = id;itemObj.wt = jsObj.wt;localStorage.setItem(k, JSON.stringify(itemObj));}
