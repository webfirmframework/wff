...
public class WffJsFileTest {
    ...
    private static String expectedContent = """
            ...
            * v2;var v3 = v18
            ...
            var name = v77[i].name;var v44 = f29(name.length,
            v14);f34(v11, v44);f34(v11, name);var values = v77[i].values;if(values.length == 0){
            f34(v11, f29(0,
            v12));}else{
            var v73 = 0;for (var l = 0; l < values.length; l++){
            v73 += values[l].length;}
            v73 += (v12 * values.length);var v37 = f29(v73,
            ...
            v58, v10);v58 = v58 + v10;var v49 = f15(v39);var v86 = subarray(message, v58,
            v49);v58 = v58 + v86.length;v85.name = v86;var v35 = subarray(message,
            v58, v8);v58 = v58 + v8;v49 = f15(v35);var v78 = subarray(message, v58,
            v49);v58 = v58 + v78.length - 1;var v9 = f7(
            v8, v78);v85.values = v9;v77.push(v85);}
            return v77;};
            var f7 = function(v8, v78){
            var values = [];for (var i = 0; i < v78.length; i++){
            var v35 = subarray(v78, i,
            v8);var v67 = f15(v35);var value = subarray(v78, i
            + v8, v67);values.push(value);i = i + v8 + v67 - 1;}
            return values;};
            var f34 = function(v53, v41){
            for (var a = 0; a < v41.length; a++){
            v53.push(v41[a]);}
            };
            var f4 = function(v53, v79,
            position, length){
            ...
            var bytes = [ (value >> 24), (value >> 16), (value >> 8), value ];return bytes;};this.f40 = f40;
            ...
            return [ v68, v72 ];}
            return [ v81, v68, v72 ];}
            return [ v66, v81, v68, v72 ];};this.f16 = f16;
            ...
            var f33 = function(v63){
            var arrayBuff = new ArrayBuffer(8);var float64 = new Float64Array(arrayBuff);float64[0] = v63;var uin = new Int8Array(arrayBuff);return Array.from(uin).reverse();};this.f33 = f33;
            ...
            var v97 = wffBMUtil.f15(utf8Bytes);return wffGlobal.NDXD_TGS[v97];}
            var v7 = utf8Bytes[0];if(v7 > 0){
            var v26 = subarray(utf8Bytes, 1, v7);var v97 = wffBMUtil.f15(v26);return wffGlobal.NDXD_TGS[v97];}else{
            var v61 = utf8Bytes.length - 1;var v60 = subarray(utf8Bytes, 1, v61);return f31(v60);}
            };this.f5 = f5;var getAttrNameFromCompressedBytes = function(utf8Bytes){
            if(utf8Bytes.length == 1){
            var v83 = wffBMUtil.f15(utf8Bytes);return wffGlobal.NDXD_ATRBS[v83];}
            var v5 = utf8Bytes[0];if(v5 > 0){
            var v19 = subarray(utf8Bytes, 1, v5);var v83 = wffBMUtil.f15(v19);return wffGlobal.NDXD_ATRBS[v83];}else{
            var v61 = utf8Bytes.length - 1;var v93Bytes = subarray(utf8Bytes, 1, v61);return f31(v93Bytes);}
            ...
            var ng = v5 < 0;var v5 = ng ? Math.abs(v5) : v5;var v19 = subarray(utf8Bytes, 1, v5);var v83 = wffBMUtil.f15(v19);var v84 = utf8Bytes.length - (v5 + 1);var v69 = subarray(utf8Bytes, v5 + 1, v84);var v88 = ng ? wffBMUtil.f15(v69).toString() : f31(v69);return [wffGlobal.NDXD_ATRBS[v83], v88];}else if(v5 == 0){
            ...
            var pfx = wffGlobal.WFF_ID_PFXS[ndx];return ["data-wff-id", pfx + wffBMUtil.f15(subarray(utf8Bytes, 1, utf8Bytes.length)).toString()];}
            ...
            };this.f17 = function(tagName, v101){
            ...
            return elements[0];};this.f41 = function(v101){
            var elements = document.querySelectorAll('[data-wff-id="' + v101
            + '"]');if(elements.length > 1){
            wffLog('multiple tags with same wff id', 'v101', v101);}
            return elements[0];};
            this.f24 = function(v76){
            var v103 = f31([ v76[0] ]);var intBytes = [];for (var i = 1; i < v76.length; i++){
            intBytes.push(v76[i]);}
            var v102 = wffBMUtil.f15(intBytes);return v103 + v102;};this.f26 = function(tag){
            var v88 = tag.getAttribute("data-wff-id");if(v88 == null){
            v88 = "C" + wffGlobal.getUniqueWffIntId();tag.setAttribute("data-wff-id", v88);}
            var v103 = v88.substring(0, 1);var v52 = encoder.encode(v103);var v76 = [ v52[0] ];var v102 = v88.substring(1, v88.length);var v75 = wffBMUtil.f16(parseInt(v102));v76 = v76.concat(v75);return v76;};var f32 = function(v57){
            var v93;var v88;var v31 = v57.indexOf('=');if(v31 != -1){
            v93 = v57.substring(0, v31);v88 = v57.substring(v31 + 1,
            v57.length);}else{
            v93 = v57;v88 = '';}
            return [ v93, v88 ];};this.f32 = f32;this.f19 = function(bytes){
            var v77 = wffBMUtil.f10(bytes);var v16 = v77[0];var v29 = v16.values;var v98 = [];var parent;var v55 = f31(v29[0]);if(v55 === '#'){
            var text = f31(v29[1]);parent = document.createDocumentFragment();parent.appendChild(document.createTextNode(text));}else if(v55 === '@'){
            ...
            var v57 = f32(f31(v29[i]));parent[v57[0]] = v57[1];parent.setAttribute(v57[0], v57[1]);}
            }
            v98.push(parent);for (var i = 1; i < v77.length; i++){
            var name = v77[i].name;var values = v77[i].values;var tagName = f31(values[0]);var child;if(tagName === '#'){
            ...
            var v57 = f32(f31(values[j]));child[v57[0]] = v57[1];child.setAttribute(v57[0], v57[1]);}
            }
            v98.push(child);var v62 = wffBMUtil.f15(name);v98[v62].appendChild(child);}
            return parent;};this.f2 = function(bytes){
            var v77 = wffBMUtil.f10(bytes);var v16 = v77[0];var v29 = v16.values;var v98 = [];var parent;var v55 = f5(v29[0]);if(v55 === '#' || v55 === '$'){
            var txt = v55 === '$' ? wffBMUtil.f15(v29[1]).toString()
            : v55 === '#' ? f31(v29[1]) : '';parent = document.createDocumentFragment();parent.appendChild(document.createTextNode(txt));}else if(v55 === '@'){
            var txt = f31(v29[1]);parent = document.createDocumentFragment();f27(parent, txt);}else{
            parent = document.createElement(v55);for (var i = 1; i < v29.length; i++){
            var v57 = f1(v29[i]);parent[v57[0]] = v57[1];parent.setAttribute(v57[0], v57[1]);}
            }
            v98.push(parent);for (var i = 1; i < v77.length; i++){
            var name = v77[i].name;var values = v77[i].values;var tagName = f5(values[0]);var child;if(tagName === '#' || tagName === '$'){
            var txt = tagName === '$' ? wffBMUtil.f15(values[1]).toString()
            : tagName === '#' ? f31(values[1]) : '';child = document.createDocumentFragment();child.appendChild(document.createTextNode(txt));}else if(tagName === '@'){
            var text = f31(values[1]);child = document.createDocumentFragment();f27(child, text);}else{
            child = document.createElement(tagName);for (var j = 1; j < values.length; j++){
            ...
            'name' : tUtf8Bytes,
            'values' : [ cUtf8Bytes ]
            };v77.push(v47);var v92 = wffTagUtil.f26(tag);var v85 = {
            'name' : v92,
            'values' : []
            };v77.push(v85);return wffBMUtil.f14(v77);};this.f13 = function(v93, v88, v65){
            var v77 = [];var tUtf8Bytes = encoder.encode("T");var cUtf8Bytes = encoder.encode("UA");var v47 = {
            'name' : tUtf8Bytes,
            'values' : [ cUtf8Bytes ]
            };v77.push(v47);var v24 = encoder.encode(v93 + "="
            + v88);var v85 = {
            'name' : wffBMUtil.f16(v65),
            'values' : [ v24 ]
            };v77.push(v85);return wffBMUtil.f14(v77);};var f44 = function(v77, tag, v62){
            ...
            f44(v77, tag.childNodes[i], v62);}
            };this.f20 = function(tag, v42){
            var v77 = [];var tUtf8Bytes = encoder.encode("T");var cUtf8Bytes = encoder.encode("C");var v47 = {
            'name' : tUtf8Bytes,
            'values' : [ cUtf8Bytes ]
            };v77.push(v47);var v62 = 0;f44(v77, tag, v62);v77[1].name = wffBMUtil.f16(v42);return wffBMUtil.f14(v77);};};
            ...
            return decoder.decode(new Uint8Array(utf8Bytes));};var f45 = function(v77){
            ...
            var v101 = wffTagUtil.f24(v100[j]);var v50 = wffTagUtil.f41(v101);v50[v93] = v88;v50.setAttribute(v93, v88);}
            }
            }
            ...
            for (var i = 1; i < v77.length; i++){
            var v101 = wffTagUtil
            .f24(v77[i].name);var values = v77[i].values;var tagName = wffTagUtil.f5(values[0]);var parent = wffTagUtil.f17(tagName, v101);for (var j = 1; j < values.length; j++){
            var v90 = wffTagUtil
            .f19(values[j]);parent.appendChild(v90);}
            }
            }else if(taskValue == wffGlobal.taskValues.REMOVED_TAGS){
            for (var i = 1; i < v77.length; i++){
            var v101 = wffTagUtil
            .f24(v77[i].name);var values = v77[i].values;var tagName = wffTagUtil.f5(values[0]);var v64 = wffTagUtil.f17(tagName,
            v101);var parent = v64.parentNode;parent.removeChild(v64);}
            }else if(taskValue == wffGlobal.taskValues.REMOVED_ALL_CHILDREN_TAGS){
            for (var i = 1; i < v77.length; i++){
            var v101 = wffTagUtil
            .f24(v77[i].name);var values = v77[i].values;var tagName = wffTagUtil.f5(values[0]);var parentTag = wffTagUtil.f17(tagName,
            ...
            for (var i = 1; i < v77.length; i++){
            var v25 = wffTagUtil
            .f24(v77[i].name);var values = v77[i].values;var v17 = wffTagUtil.f5(values[0]);var v33 = wffTagUtil.f17(
            v17, v25);var v94 = null;if(values[2].length == 0){
            v94 = wffTagUtil.f19(values[3]);}else{
            var v59 = wffTagUtil.f5(values[2]);var v74 = wffTagUtil.f24(values[1]);v94 = wffTagUtil.f17(v59,
            ...
            v94 = wffTagUtil.f19(values[3]);}
            }
            v33.appendChild(v94);}
            }else if(taskValue == wffGlobal.taskValues.ADDED_ATTRIBUTES){
            for (var i = 1; i < v77.length; i++){
            var v85 = v77[i];if(v85.name[0] == wffGlobal.taskValues.MANY_TO_ONE){
            var tagName = wffTagUtil.f5(v85.values[0]);var v101 = wffTagUtil
            .f24(v85.values[1]);var v50 = wffTagUtil.f17(
            ...
            .f24(v85.values[1]);var v50 = wffTagUtil.f17(
            tagName, v101);for (var j = 2; j < v85.values.length; j++){
            var v93 = wffTagUtil.getAttrNameFromCompressedBytes(v85.values[j]);v50.removeAttribute(v93);if(wffGlobal.NDXD_BLN_ATRBS.indexOf(v93) != -1){
            ...
            var tagName = wffTagUtil.f5(v77[1].name);var v101 = wffTagUtil
            .f24(v77[1].values[0]);var parentTag = wffTagUtil.f17(tagName,
            v101);while (parentTag.firstChild){
            parentTag.removeChild(parentTag.firstChild);}
            for (var i = 2; i < v77.length; i++){
            var values = v77[i].values;var v90 = wffTagUtil.f19(v77[i].name);if(values.length == 1 && values[0].length == 1){
            ...
            var tagName = wffTagUtil.f5(v77[1].name);var v101 = wffTagUtil.f24(v77[1].values[0]);var parentTag = wffTagUtil.f17(tagName, v101);var v51 = wffTagUtil.f5(v77[2].name);var v87;if(v51 === '#'){
            var v20 = v77[2].values[0];v87 = wffTagUtil.f22(parentTag, v20);}else{
            var v43 = wffTagUtil.f24(v77[2].values[0]);v87 = wffTagUtil.f17(v51,
            v43);}
            for (var i = 3; i < v77.length; i++){
            var nm = v77[i].name;var values = v77[i].values;var v90 = wffTagUtil.f19(values[0]);if(nm.length == 1){
            var existingTag = wffTagUtil.f17(
            v90.nodeName, v90
            ...
            var js = f31(v47.values[1]);var op = v47.values[2][0];if(op == 1){
            ...
            if(jsObj.cb){
            var v47 = wffTaskUtil.f35(
            wffGlobal.taskValues.TASK,
            taskValue);var v85 = {
            'name': jsObj.id,
            'values': []
            };var v77 = [v47, v85];var wffBM = wffBMUtil.f14(v77);wffWS.send(wffBM);}
            }
            ...
            var tagName = wffTagUtil.f5(v77[1].name);var v101 = wffTagUtil
            .f24(v77[1].values[0]);var tag = wffTagUtil.f17(tagName, v101);var ky = f31(v77[1].values[1]);var v38 = v77[1].values[2];var jsObjOrArr;if(taskValue == wffGlobal.taskValues.SET_BM_OBJ_ON_TAG){
            ...
            var tagName = wffTagUtil.f5(v77[1].name);var v101 = wffTagUtil
            .f24(v77[1].values[0]);var tag = wffTagUtil.f17(tagName, v101);var ky = f31(v77[1].values[1]);var wffObjects = tag['wffObjects'];if(typeof wffObjects !== 'undefined'){
            delete wffObjects[ky];}
            }
            return true;};this.f43 = function(v80){
            var v77 = wffBMUtil.f10(v80);var v47 = v77[0];if(v47.name[0] == wffGlobal.taskValues.TASK){
            f45(v77);}else if(v47.name[0] == wffGlobal.taskValues.TASK_OF_TASKS){
            var tasksBM = v47.values;for (var i = 0; i < tasksBM.length; i++){
            var v46 = wffBMUtil.f10(tasksBM[i]);f45(v46);}
            }else{
            return false;}
            return true;};this.f30 = function(v80){
            var v85 = wffBMUtil.f10(v80)[1];};};
            var wffTaskUtil = new function (){
            var encoder = wffGlobal.encoder;this.f35 = function(v95, valueByte){
            var v47 = {
            'name' : [v95],
            'values' : [ [valueByte] ]
            };return v47;};};var wffServerMethods = new function (){
            var encoder = wffGlobal.encoder;var f25 = function(v71){
            var v89 = [];if(typeof v71 === 'string'){
            var ndx = wffGlobal.NDXD_VNT_ATRBS.indexOf(v71);if(ndx != -1){
            var ndxByts = wffBMUtil.f16(ndx);v89.push(0);for (var i = 0; i < ndxByts.length; i++){
            v89.push(ndxByts[i]);}
            }else{
            v89 = encoder.encode(v71);}
            }else{
            var ndxByts = wffBMUtil.f16(v71);v89.push(0);for (var i = 0; i < ndxByts.length; i++){
            v89.push(ndxByts[i]);}
            }
            return v89;};var f42 = function(event, tag, v71, prvntDflt){
            if(prvntDflt){
            event.preventDefault();}
            var v47 = wffTaskUtil.f35(wffGlobal.taskValues.TASK, wffGlobal.taskValues.INVOKE_ASYNC_METHOD);var v89 = f25(v71);var v85 = {'name':wffTagUtil.f26(tag), 'values':[v89]};var v77 = [v47, v85];var wffBM = wffBMUtil.f14(v77);wffWS.send(wffBM);};this.b = function(event, tag, v71){
            f42(event, tag, v71, true);};var invokeAsync = function(event, tag, v71){
            f42(event, tag, v71, false);};this.a = invokeAsync;var f23 = function(event, tag, v71, preFun, prvntDflt){
            if(prvntDflt){
            event.preventDefault();}
            var invoked = false;var actionPerform = function(){
            invoked = true;var v47 = wffTaskUtil.f35(wffGlobal.taskValues.TASK, wffGlobal.taskValues.INVOKE_ASYNC_METHOD);var v89 = f25(v71);var v85 = {'name':wffTagUtil.f26(tag), 'values':[v89]};var v77 = [v47, v85];var wffBM = wffBMUtil.f14(v77);wffWS.send(wffBM);};var action = new function(){
            ...
            f23(event, tag, v71, preFun, true);};var invokeAsyncWithPreFun = function(event, tag, v71, preFun){
            f23(event, tag, v71, preFun, false);};this.e = invokeAsyncWithPreFun;var f6 = function(event, tag, v71, preFun, filterFun, prvntDflt){
            if(prvntDflt){
            event.preventDefault();}
            var invoked = false;var actionPerform = function(){
            invoked = true;var v47 = wffTaskUtil.f35(wffGlobal.taskValues.TASK, wffGlobal.taskValues.INVOKE_ASYNC_METHOD);var v89 = f25(v71);var jsObject = filterFun(event, tag);var v32 = new WffBMObject(jsObject);var v96 = v32.getBMBytes();var v85 = {'name':wffTagUtil.f26(tag), 'values':[v89, v96]};var v77 = [v47, v85];var wffBM = wffBMUtil.f14(v77);wffWS.send(wffBM);};var action = new function(){
            this.perform = function(){
            actionPerform();};};if(preFun(event, tag, action)){
            if(!invoked){
            actionPerform();}
            ...
            f6(event, tag, v71, preFun, filterFun, true);};var invokeAsyncWithPreFilterFun = function(event, tag, v71, preFun, filterFun){
            f6(event, tag, v71, preFun, filterFun, false);};this.g = invokeAsyncWithPreFilterFun;var f11 = function(event, tag, v71, filterFun, prvntDflt){
            if(prvntDflt){
            event.preventDefault();}
            var v47 = wffTaskUtil.f35(wffGlobal.taskValues.TASK, wffGlobal.taskValues.INVOKE_ASYNC_METHOD);var v89 = f25(v71);var jsObject = filterFun(event, tag);var v32 = new WffBMObject(jsObject);var v96 = v32.getBMBytes();var v85 = {'name':wffTagUtil.f26(tag), 'values':[v89, v96]};var v77 = [v47, v85];var wffBM = wffBMUtil.f14(v77);wffWS.send(wffBM);};this.d = function(event, tag, v71, filterFun){
            f11(event, tag, v71, filterFun, true);};var invokeAsyncWithFilterFun = function(event, tag, v71, filterFun){
            f11(event, tag, v71, filterFun, false);};this.c = invokeAsyncWithFilterFun;};var wffSM = wffServerMethods;
            ...
            var v77 = wffBMUtil.f10(v80);var v47 = v77[0];var taskValue = v47.values[0][0];if(v47.name[0] != wffGlobal.taskValues.TASK){
            return false;}
            if(taskValue == wffGlobal.taskValues.INVOKE_POST_FUNCTION){
            var funString = f31(v77[1].name);var values = v77[1].values;var jsObject = null;if(values.length > 0){
            ...
            var funKey = f31(v77[1].name);var cbFun = wffAsync.v27[funKey];var values = v77[1].values;var jsObject = null;if(values.length > 0){
            var value = values[0];if(value.length > 0){
            var bmObjBytes = v77[1].values[0];jsObject = new JsObjectFromBMBytes(bmObjBytes, true);}
            }
            ...
            return wffBMUtil.f14(v77);};this.getBMBytes = function getBMBytes(){
            ...
            name : [ arrayValType ]
            };v77.push(v85);v85.values = [ int8Array ];return wffBMUtil.f14(v77);};this.getBMBytes = function getBMBytes(){
            ...
            var encoder = wffGlobal.encoder;var decoder = wffGlobal.decoder;var f31 = function(utf8Bytes){
            return wffGlobal.decoder.decode(new Uint8Array(utf8Bytes));};var v77 = wffBMUtil.f10(v80);var i = 0;if(typeof outer === 'undefined' || outer){
            i = 1;}
            for (; i < v77.length; i++){
            var v85 = v77[i];var name = f31(v85.name);var values = v85.values;if(values[0] == 0){
            ...
            var encoder = wffGlobal.encoder;var decoder = wffGlobal.decoder;var f31 = function(utf8Bytes){
            return decoder.decode(new Uint8Array(utf8Bytes));};var v77 = wffBMUtil.f10(v80);var i = 0;if(typeof outer === 'undefined' || outer){
            i = 1;}
            ...
            var wffBM = wffBMUtil.f14(v77);wffWS.send(wffBM);};return this;};var f9 = function(uri, callback, initiator, rplc){
            var v47 = wffTaskUtil.f35(
            wffGlobal.taskValues.TASK,
            ...
            var wffBM = wffBMUtil.f14(v77);wffWS.send(wffBM);};this.setServerURIWithCallback = function(uri, callback, initiator){f9(uri, callback, initiator, false);};this.setServerURI = function(uri){ f9(uri, undefined, wffGlobal.uriEventInitiator.CLIENT_CODE, false); };var throwInvalidSetURIArgException = function(){
            ...
            var v77 = [];var v23 = encoder.encode(wffInstanceId);var tnv = wffTaskUtil.f35(
            wffGlobal.taskValues.TASK,
            wffGlobal.taskValues.REMOVE_BROWSER_PAGE);v77.push(tnv);var v85 = {
            'name' : v23,
            'values' : []
            };v77.push(v85);var wffBM = wffBMUtil.f14(v77);wffWS.send(wffBM);};this.f28 = f28;this.f21 = function(){
            ...
            var v77 = [];var tnv = wffTaskUtil.f35(
            wffGlobal.taskValues.TASK,
            ...
            var wffBM = wffBMUtil.f14(v77);wffWS.send(wffBM);};};
            ...
            var v91 = wffBMUtil.f15([binary[0], binary[1], binary[2], binary[3]]);if(v91 != 0 && v91 != wffGlobal.getUniqueServerSidePayloadId()){
            wffGlobal.onPayloadLoss();}else{
            var bin = [];for (var i = 4; i < binary.length; i++){
            bin.push(binary[i]);}
            wffClientCRUDUtil.f43(bin);}
            }else{
            ...
            bin = wffBMUtil.f40(wffGlobal.getUniqueClientSidePayloadId());for (var i = 0; i < bytes.length; i++){
            bin.push(bytes[i]);}
            }
            ...
            function(event){
            wffGlobal.getAndUpdateLocation();var encoder = wffGlobal.encoder;if(typeof window.f38Invoked === 'undefined'){
            ...
            var ky = encoder.encode(event.key.substring(0, ndx));var wtBts = encoder.encode(itemObj.wt);var id = wffBMUtil.f16(itemObj.id);var v77;if(itemObj.removed){
            var v47 = wffTaskUtil.f35(
            wffGlobal.taskValues.TASK,
