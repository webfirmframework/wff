...
public class WffJsFileTest {
    ...
    private static String expectedContent = """
            ...
            * v2;var v3 = v18
            ...
            throwInvalidSetURIArgException();}
            var uriBefore = window.location.pathname;if(uri === uriBefore || uri === window.location.href){
            return;}
            if(replace){
