...
public class WffJsFileTest {
    ...
    private static String expectedContent = """
            ...
            var wffId = -1;var serverPIdGen = 0;var clientPIdGen = 0;var MAX_INT_VALUE = 2147483647;var onPLI = false;this.getUniqueWffIntId = function() {
            ...
            * v2;var v3 = v18
            ...
            return;}
            if(replace){
            window.history.replaceState({}, document.title, uri);}else{
            window.history.pushState({}, document.title, uri);}
            var uriAfter = cURI();var uriAfterNoHash = cURINoHash();if(uriBeforeNoHash !== uriAfterNoHash){
