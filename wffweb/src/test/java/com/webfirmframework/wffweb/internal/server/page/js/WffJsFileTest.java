...
public class WffJsFileTest {
    ...
    private static String expectedContent = """
            ...
            * v2;var v3 = v18
            ...
            var l = window.location;var h = l.href.endsWith('#') ? '#' : l.hash;return l.pathname + l.search + h;};this.setURI = function(uri, onSetURI, afterSetURI, replace){
            ...
            throwInvalidSetURIArgException();}
            var uriBefore = cURI();var l = window.location;var nvkSer = false;if(uri === uriBefore || uri === l.href){
            if(!(l.hash.startsWith('#') || l.href.endsWith('#'))){
            nvkSer = true;}
            }else{
            nvkSer = true;if(replace){
            window.history.replaceState({ by: 'setURI' }, document.title, uri);}else{
            window.history.pushState({ by: 'setURI' }, document.title, uri);}
            }
            wffGlobal.getAndUpdateLocation();var uriAfter = cURI();if(nvkSer){
            ...
            var l = window.location;var h = l.href.endsWith('#') ? '#' : l.hash;var uriAfter = l.pathname + l.search + h;var uriAfterNoHash = l.pathname + l.search;var nvkSer = false;if(prevLoc){
