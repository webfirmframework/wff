...
public class WffJsFileTest {
    ...
    private static String expectedContent = """
            ...
            * v2;var v3 = v18
            ...
            var prefix = null;if(v5 == -1){
            prefix = 'S';}else if(v5 == -2){
            prefix = 'C';}else{
            wffLog("Invalid wff data found. Unable to handle value check ", v5);return null;}
