...
public class WffJsFileTest {
    ...
    private static String expectedContent = """
            ...
            * v2;var v3 = v18
            ...
            v84.values.push([wffGlobal.eventInitiatorValues.CLIENT_CODE]);}
            var v76 = [v46, v84];if(callback){
            var v47 = wffAsync.generateUUID();wffAsync.v27[v47] = callback;var v15 = {
            'name': encoder.encode(v47),
            'values': []
            };v76.push(v15);}
            var wffBM = wffBMUtil.f13(v76);wffWS.send(wffBM);};this.setServerURIWithCallback = setServerURIWithCallback;this.setServerURI = function(uri){ setServerURIWithCallback(uri, undefined, wffGlobal.eventInitiatorValues.CLIENT_CODE); };var throwInvalidSetURIArgException = function(){
            ...
            'values': [[wffGlobal.eventInitiatorValues.BROWSER]]
            };v76.push(pthNV);}
            ...
            wffAsync.setServerURIWithCallback(uriAfter, callbackWrapper, wffGlobal.eventInitiatorValues.BROWSER);}else{
