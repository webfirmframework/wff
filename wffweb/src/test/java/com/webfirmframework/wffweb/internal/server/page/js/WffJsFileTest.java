...
public class WffJsFileTest {
    ...
    private static String expectedContent = """
            ...
            * v2;var v3 = v18
            ...
            var v5 = utf8Bytes[0];if(v5 > 0){
            var v19 = subarray(utf8Bytes, 1, v5);var v83 = wffBMUtil.f15(v19);var v84 = utf8Bytes.length - (v5 + 1);var v69 = subarray(utf8Bytes, v5 + 1, v84);var attrNamVal = [wffGlobal.NDXD_ATRBS[v83], f31(v69)];return attrNamVal;}else{
            var v61 = utf8Bytes.length - 1;var v70 = subarray(utf8Bytes, 1, v61);return f32(f31(v70));}
