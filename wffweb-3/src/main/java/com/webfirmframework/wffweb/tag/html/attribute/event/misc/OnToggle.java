...
public class OnToggle extends AbstractEventAttribute {
    ...
    public OnToggle(final String jsPreFunctionBody, final ServerAsyncMethod serverAsyncMethod,
     ...
     * @since 3.0.2
     */
    public OnToggle(final ServerAsyncMethod serverAsyncMethod, final Object serverSideData) {
