...
The framework size is very low so you can build complete web application alone with this framework which can be run on [low cost low memory servers](http://www.mochahost.com/6128-46-1-253.html?id=6128&tid1=github&tid2=webfirmframework&tid3=wffweb).
